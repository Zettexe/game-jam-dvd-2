...
Ta-ta!"},
	...
	ScriptedDialogue.GOTCAT: [
		{ "character": Character.HUNTRESS, "content": "Oh yeah, that reminds me..."},
		{ "character": Character.GUARD, "content": "That what?"},
		{ "character": Character.HUNTRESS, "content": "What?"},
		{ "character": Character.GUARD, "content": "What's that?"},
		{ "character": Character.HUNTRESS, "content": "Oh. That... Uh... Natalia becoming a cat."},
		{ "character": Character.GUARD, "content": "...Who's Natalia?"},
		{ "character": Character.HUNTRESS, "content": "...Okay, you've been around here before her.
													You could at least try to remember the name of the girl serving your drinks."},
		{ "character": Character.GUARD, "content": "Oh, that Natalia!"},
		{ "character": Character.HUNTRESS, "content": "Yeah. Who else did you even see becoming a cat?!"},
		{ "character": Character.GUARD, "content": "She became a cat?"},
		{ "character": Character.HUNTRESS, "content": "Dude."},
		{ "character": Character.GUARD, "content": "What?"},
		{ "character": Character.HUNTRESS, "content": "You were here. Beside me. Like, not even five minutes ago."},
		{ "character": Character.GUARD, "content": "Yeah?"},
		{ "character": Character.HUNTRESS, "content": "...Yeah? So..."},
		{ "character": Character.GUARD, "content": "But she seems human to me."},
		{ "character": Character.HUNTRESS, "content": "Well, yeah, she turned back..."},
		{ "character": Character.GUARD, "content": "Okay, so what's the deal?"},
		{ "character": Character.HUNTRESS, "content": "She was turned into one!"},
		{ "character": Character.GUARD, "content": "Ah, is that what the sexy witch was doing?"},
		{ "character": Character.HUNTRESS, "content": "Figures."},
		{ "character": Character.GUARD, "content": "What?"},
		{ "character": Character.HUNTRESS, "content": "Nothing."},
		{ "character": Character.GUARD, "content": "Mkay."},
		{ "character": Character.HUNTRESS, "content": "Anyway, I was saying..."},
		{ "character": Character.GUARD, "content": "Yeah, what did it remind you of?"},
		{ "character": Character.HUNTRESS, "content": "I got a cat!"},
		{ "character": Character.GUARD, "content": "Oh really?"},
		{ "character": Character.HUNTRESS, "content": "Yeah!"},
		{ "character": Character.GUARD, "content": "Is it Natalia?"},
		{ "character": Character.HUNTRESS, "content": "...What? No?"},
		{ "character": Character.GUARD, "content": "Then why—"},
		{ "character": Character.HUNTRESS, "content": "Because I saw a cat! With the same color! Can I tell you about it?"},
		{ "character": Character.GUARD, "content": "Oh sure, if you wanna."},
		{ "character": Character.HUNTRESS, "content": "...Why are we even friends?"},
		{ "character": Character.GUARD, "content": "I dunno. You helped me out with math when we were little."},
		{ "character": Character.HUNTRESS, "content": "And I regret it ever since. You even went and became a guard."},
		{ "character": Character.GUARD, "content": "What's that supposed to mean?"},
		{ "character": Character.HUNTRESS, "content": "Oh, you know full well."},
		{ "character": Character.GUARD, "content": "Know what?!"},
		{ "character": Character.HUNTRESS, "content": "The fact I don't like guards!"},
		{ "character": Character.GUARD, "content": "Why? We have a cool armor!"},
		{ "character": Character.HUNTRESS, "content": "You're the symbolic representation of the oppression we face every day from the monarch.
													You're an enabler for that kind of stronghanding."},
		{ "character": Character.GUARD, "content": "Uh—"},
		{ "character": Character.HUNTRESS, "content": "Not to mention how the laws you enforce are biased against the poor."},
		{ "character": Character.GUARD, "content": "Well—"},
		{ "character": Character.HUNTRESS, "content": "Why in the seven hells are you allowed to pay off your time in jail with a fine? That's just a punishment for not having money!"},
		{ "character": Character.GUARD, "content": "I don't make the rules—"},
		{ "character": Character.HUNTRESS, "content": "But you enforce them! You're complicit in the propagation of an unfair and prejudiced system."},
		{ "character": Character.GUARD, "content": "...So, about that cat..."},
		{ "character": Character.HUNTRESS, "content": "Oh, NOW you want to know about the cat?"},
		{ "character": Character.GUARD, "content": "Y-Yeah."},
		{ "character": Character.HUNTRESS, "content": "..."},
		{ "character": Character.GUARD, "content": "..."},
		{ "character": Character.HUNTRESS, "content": "Yeah, so."},
		{ "character": Character.HUNTRESS, "content": "I was walking home a couple of days ago."},
		{ "character": Character.HUNTRESS, "content": "Heard some shouting, so I went to look. Since you guards are useless."},
		{ "character": Character.GUARD, "content": "Aw, come on now."},
		{ "character": Character.HUNTRESS, "content": "It came from the blacksmith's house."},
		{ "character": Character.GUARD, "content": "Oh, John and Pauline? Were they fighting?"},
		{ "character": Character.HUNTRESS, "content": "I think so. Seems like it happens often."},
		{ "character": Character.GUARD, "content": "Ah, yeah. Pauline came in the barracks the other day."},
		{ "character": Character.HUNTRESS, "content": "Huh?"},
		{ "character": Character.GUARD, "content": "Yeah, someone complained about the noise, and she came to explain that it was a misunderstanding."},
		{ "character": Character.HUNTRESS, "content": "...Really now?"},
		{ "character": Character.GUARD, "content": "Yeah. We got some info saying that her husband beats her, but she said it's not true, and that she got the bruises slipping from her staircase."},
		{ "character": Character.HUNTRESS, "content": "And... You believed that?"},
		{ "character": Character.GUARD, "content": "...She said it?"},
		{ "character": Character.HUNTRESS, "content": "...Goddess, you guards truly are useless."},
		{ "character": Character.GUARD, "content": "Wait... Useless?
													We can't just barge in if she told us not to worry!"},
		{ "character": Character.HUNTRESS, "content": "Oh, be real!"},
		{ "character": Character.GUARD, "content": "What does this have to do with the cat anyway?!"},
		{ "character": Character.HUNTRESS, "content": "Ah, right. I just found one while investigating the noise."},
		{ "character": Character.GUARD, "content": "And you took it?"},
		{ "character": Character.HUNTRESS, "content": "It followed me home. I tried to shoo it, but I just couldn't. Love those big ol' eyes."},
		{ "character": Character.GUARD, "content": "I'm more of a dog person."},
		{ "character": Character.HUNTRESS, "content": "Who the fuck asked."},
		{ "character": Character.GUARD, "content": "Why are you so mean?!"}		
	]
}
